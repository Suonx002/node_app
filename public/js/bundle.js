...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic3VvbngwMDIiLCJhIjoiY2s3OTd3bWJjMGc4OTNmbnUxdmZ0MXJpbSJ9.j21pcjXzu9YfcvzJNMTJJw';
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_GKyVCNDt0O3Gf4R3mPk5xZTl00OHhII9BQ'); // 1) Get checkout session from server (API)
...
if (bookButton) {
  bookButton.addEventListener('click', function (e) {
    e.target.textContent = 'Processing...'; // console.log(e.target.dataset);
